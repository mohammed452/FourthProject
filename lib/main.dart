...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getNews({
    ...
    if (channel != null) {
      ...
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=1d0f1be4c13942acabe568e2f098e018';
    }
    if (searchKey != null) {
      country = null;
      category = null;
      baseApi =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q=$searchKey&apiKey=1d0f1be4c13942acabe568e2f098e018';
    }
    //print(baseApi);
